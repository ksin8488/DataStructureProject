...
void BinarySearchTree<Type> :: removeNode(BinaryTreeNode<Type> * removeMe)
{
    ...
    //Node has only a left child - left version
    ...
    //Node has only a right child - right version
    ...
    //Node has both children - if both child nodes exist
    else
    {
...
Type BinarySearchTree<Type> :: findMaximum()
{
    ...
    return getRightMostChild(this->root)->etData();
}
